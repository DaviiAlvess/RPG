...
export function economyPrompt(c, lore, calendar) {
  ...
  return [
    ...
    'A câmera é o jogador ("você"): magnética, atrás/dentro dos olhos. Primeiro sujeito gramatical = campo sensorial (mão, ombro, visão). NPCs a partir de você (À sua frente…, canto do olho); proibido "o subordinado" / "o transeunte" / figura encapuzada como protagonista. Feche o turno.',
