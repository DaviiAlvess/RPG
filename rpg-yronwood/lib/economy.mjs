...
export function economyPrompt(c, lore, calendar) {
  ...
  return [
    ...
    'Nunca fale, escolha ou rotule emoção pelo jogador ("você sente medo"). Use seu nome só quando necessário. Diálogos em linhas Nome: "fala". Não liste opções obrigatórias.',
