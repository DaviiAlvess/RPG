...
export function buildNarrationDirection(value) {
  ...
  return [
    ...
    'Cada cena deve servir a uma intenção ou pergunta concreta, sem inventar objetivos para o jogador. Comece perto do momento relevante e encerre quando a situação mudar ou pedir uma escolha.',
    'Use um detalhe sensorial significativo que revele ambiente, pista ou caráter; não uma lista decorativa de sentidos. Varie a extensão das frases conforme ação, conversa ou repouso.',
