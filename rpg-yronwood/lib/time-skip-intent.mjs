...
Mostre a passagem do tempo de dentro do intervalo: alguns momentos vividos e ligados entre si, o que chega aos olhos, ouvidos e mãos de onde o personagem está — não uma lista de dias nem um checklist de cenas. Dê um detalhe de progresso e uma consequência coerente quando houver; não force tragédia, combate ou reviravolta.
