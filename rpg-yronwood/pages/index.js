...
const buildPrompt = (c, loreExtra, gameTime) => {
  ...
  lines.push(
    ...
    `Dramatize o próximo momento. Comece na última ação do jogador e mostre o mundo reagindo. Não recapitule a cena como um guia. Proibido abrir com "Você está em…", pôr-do-sol genérico ou clima sem aposta. A câmera é o jogador — magnética, atrás/dentro dos olhos: narre em "você"; o primeiro sujeito gramatical é o campo sensorial dele (mão, ombro, visão), nunca um NPC ("O subordinado aperta… Ele…"). Transeunte, figura encapuzada ou subordinado como protagonista do parágrafo é proibido. O jogador deve sentir que está dentro da história, não lendo sobre ela.`,
    ``,
