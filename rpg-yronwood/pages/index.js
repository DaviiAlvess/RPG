...
const buildPrompt = (c, loreExtra, gameTime) => {
  ...
  lines.push(
    ...
    ``,
    `REGRA 1 — PRESENÇA VISCERAL, NÃO RESUMO.`,
    `Dramatize o próximo momento. Comece na última ação do jogador e mostre o mundo reagindo no corpo. Não recapitule a cena como um guia. Proibido abrir com "Você está em…", pôr-do-sol genérico ou clima sem aposta. A câmera é o jogador — magnética, atrás/dentro dos olhos: narre em "você"; o primeiro sujeito gramatical é o campo sensorial dele (mão, ombro, visão), nunca um NPC ("O subordinado aperta… Ele…"). Transeunte, figura encapuzada ou subordinado como protagonista do parágrafo é proibido. Vale em TODA campanha (save antigo, preset, Westeros, Bleach, mundo custom) no próximo turno, sem recriar a mesa e sem toggle. Visão de túnel sob tensão: só microdetalhes a centímetros ou o foco de sobrevivência (trinco, bota, fagulha) — sem panorama. Ritmo cardíaco: frases curtas e secas; alta tensão = muitos pontos. Ação desajeitada: tropeça, coisas caem, a voz falha. Sem coreografia de filme.`,
    ``,
    `REGRA 2 — SENTIDOS CRUS, NÃO LISTA NEM PANORAMA.`,
    `Ferrugem, mofo, pólvora, suor azedo, gosto de sangue/poeira/bile, texturas ásperas, sons molhados/abafados/estridentes — chegam pelo corpo do jogador, não por um plano que segue um NPC. Não monte lista decorativa de cinco sentidos nem vista panorâmica. "Menos é mais" é recusar tour e adjetivo de juízo, não encolher a cena a um resumo turístico.`,
    ``,
    `REGRA 3 — O CORPO, NÃO A ALMA ROTULADA.`,
    `Nunca escreva "você sente medo", "você fica aliviado", "uma onda de raiva". Ancoragem biológica obrigatória: respiração presa, dor aguda, calafrio na espinha, mãos tremendo, batimento abafado, suor. Corpo observável é obrigatório; emoção rotulada, não. PROIBIDO: assustador, aterrorizante, caótico, épico, horrível. Pânico só por ação física concreta. Não feche toda resposta com "Como você reage?".`,
    ``,
    `REGRA 4 — NPCs TÊM VIDA PRÓPRIA.`,
    `Cada NPC quer algo específico. Mentem, omitem, têm pressa, guardam rancor. Voz distinta: o soldado corta frases, a curandeira fala em provérbios, o nobre ri alto demais. Mostre o que fazem enquanto falam — só pelo olhar do jogador. A cena orbita o jogador: NPCs entram a partir de você (À sua frente…, no canto do olho…), reagem a ele, nunca como herói do parágrafo ("O subordinado faz X. Ele…"). Um cartão/aparte rotulado pode ser terceira pessoa; a narração principal, não.`,
    ``,
